...
<html>
					...
					<ul class="user-nav">
						...
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								...
								<li><a href="#"><span class=""></span> Settings</a></li> -->
								<li class="divider"></li>
			...
			<div class="row center-container">
				<div class="col-md-2 left-nav">
					<ul class="nav nav-stacked left-menu">
					   ...
					   <!-- <li role="presentation"><a href="#arts">Stock</a></li> -->
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="panel panel-default slider-content">
										<div class="panel-heading">
											<h4>Upload Art<a href="#" class="pull-right" name="slider_add"  data-toggle="modal" data-target="#slider_img_add">Add&nbsp;&nbsp;<span class="glyphicon glyphicon-plus"></span></a></h4>
										</div>
										<div class="panel-body">
												...
												<form class="form-inline" method="post" enctype="multipart/form-data">
												  ...
												  <a href="tp.php"><font face="Comic Sans MS" size="6"  class="container">  View Data </font> </a>
      ...
      <div class="container-fluid cart-container">
				<div class="panel panel-default">
				  <div class="panel-heading">Refill the stocks</div>
				  <div class="panel-body">
				 ...
				 <?php
					  ...
					  while($s=mysqli_fetch_assoc($result))
					  {
						 ...
						 $q=$s['qty'];
							if($q<5){
							echo "<tr> <td> ".$s['sell_id']."</td><td><p> ".$s['cat']." </p></td> <td> <p> ".$s['qty']."</p></td>";
				 ...
				 ?> 
					...
					$sql="CALL 'get_total'(@p0)";
					$res=mysqli_query($link,$sql);
										
					$sql1="SELECT @p0 AS 'sum'";
      ...
      <div class="container-fluid cart-container">
				<div class="panel panel-default">
				  <div class="panel-heading">Billings Done</div>
				  <div class="panel-body">
					<table class="table cart_table" align="center">
					  <tr style="font-weight:bolder">
						<td>Order Number</td>
				 ...
				 <?php
					  ...
					  $query="select * from order_day";
					  $result=mysqli_query($link,$query) or die("Error fetching data.".mysqli_error($link));
					  while($s=mysqli_fetch_assoc($result))
					  {
							
							echo "<tr> <td> ".$s['id']." </td> <td> ".$s['sell_id']."</td> <td> <p> ".$s['q']."</p></td>";
				 ...
				 ?> 
					...
					<?php
					$total1=0;
					$query3="select * from order_day";
					  $result3=mysqli_query($link,$query3) or die("Error fetching data.".mysqli_error($link));
					  while($s3=mysqli_fetch_assoc($result3))
					  {
						  $q1=$s3['q'];
						  $total1=($total1+$q1);
					  }
					   echo "Total Pieces Sold are $total1";
					?>
