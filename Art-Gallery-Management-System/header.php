	  ...
	  <div class="modal-dialog popup" role="document">
		<div class="modal-content">
		  ...
		  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			...
			<div class="panel-heading" style="text-align:center"> <font color="Black" >New Registration </font> </div>
	...
	<div class="modal fade" id="signin" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      ...
      <div class="social-icon-area">
            <ul class="social-icons">
			    <li><a href="fb.php" class="btn azm-social azm-size-48 azm-long-shadow azm-facebook"><i class="fa fa-facebook"></i></a></li> 
               <!-- <li><a href="<?php echo $socialdetails['facebook']; ?>" class="btn azm-social azm-size-48 azm-long-shadow azm-facebook"><i class="fa fa-facebook"></i></a></li> -->
			    <li><a href="twitter.php" class="btn azm-social azm-size-48 azm-long-shadow azm-twitter"><i class="fa fa-twitter"></i></a></li>
				...
				<li><a href="inn.php" class="btn azm-social azm-size-48 azm-long-shadow azm-linkedin"><i class="fa fa-linkedin"></i></a></li>
				...
				<li><a href="insta.php" class="btn azm-social azm-size-48 azm-long-shadow azm-instagram"><i class="fa fa-instagram"></i></a></li>
            </ul>
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top">
		  <div class="container-fluid">
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="#"> <font color="Yellow" >Art Gallery </font> </a>
			</div>
			<div>
					 ...
					 <form class="navbar-form navbar-left">
					  <div class="input-group">
						...
						<div class="input-group-btn">
						  <!--<button class="btn btn-default" type="submit">--> <img src="tap.jpg " height="70px" width="420px">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav navbar-right top_menu">
				...
				<li <?php if($page=="index") echo 'class="active"' ?>><a href="index.php"> <font color="yellow">Home </font> <span class="sr-only">(current)</span></a></li>
				<li <?php if($page=="aboutus") echo 'class="active"' ?>><a href="about_us.php"><font color="yellow"> About us </font> </a></li>
				<li class="dropdown <?php if($page=="arts") echo "active" ?>">
				  <a href="arts.php" class="dropdown-toggle <?php if($page=="arts") echo "active" ?>" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <font color="yellow"> Arts </font> <span class="caret"></span></a>
				  <ul class="dropdown-menu">
					<!-- <li><a href="arts.php">View Paintings</a></li> -->
					
					<li role="separator" class="divider"></li>
					<li><a href="arts.php"> <font color="blue"> Historic </font> </a></li>
					<li><a href="oil.php"> <font color="blue"> Oil Painting </font> </a></li>
					<li><a href="trail.php"> <font color="blue"> Water Color Painting </font> </a></li>
					<li><a href="sketch.php"> <font color="blue"> Sketches </font> </a></li>
				  </ul>
				</li>
				<li <?php if($page=="contact_us") echo 'class="active"' ?>><a href="contact_us.php"> <font color="yellow"> Reach us </font> </a></li>
				<li <?php if($page=="cart") echo 'class="active"' ?>><a href="cart.php"><font color="yellow"> Cart us </font> </a></li>
			  </ul>
			</div>
		  </div>
		</nav>