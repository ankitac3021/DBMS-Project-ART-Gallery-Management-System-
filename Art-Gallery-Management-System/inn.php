...
<html>
	...
	<body>
	        <div class="c1">
			<h3> <font  face="Comic Sans MS" color="black" size="6" >  We are available on Linked in </font><h3>
			<?php
				...
				$link=mysqli_fetch_assoc($result);
				 ?>
		    <h3> <font  face="Comic Sans MS" color="black" size="6" >  Search us on <?php echo $link["linkedin"] ?> </font><h3>
